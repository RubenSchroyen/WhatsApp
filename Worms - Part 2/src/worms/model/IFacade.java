...
public interface IFacade {
	 ...
	 */
	Worm createWorm(World world, double x, double y, double direction, double radius,
			String name);
	...
	boolean isImpassable(World world, double randomizedX, double randomizedY,
			double testRadius);

	boolean isAdjacent(World world, double randomizedX, double randomizedY,
			double testRadius);

	double getJumpTime(Worm worm, double jumpTimeStep);

	String getTeamName(Worm worm);

	double getMaxHitPoints(Worm worm);

	double getHitPoints(Worm worm);

	void jump(Worm worm, double jumpTimeStep);
	...
	void shoot(Worm worm, int propulsionYield);

	Projectile getActiveProjectile(World world);

	double getJumpTime(Projectile projectile, double jumpTimeStep);

	double getX(Projectile projectile);

	double getY(Projectile projectile);

	double getRadius(Projectile projectile);

	void jump(Projectile projectile, double jumpTimeStep);
